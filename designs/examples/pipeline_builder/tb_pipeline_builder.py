...
def tb(t: Tb) -> None:
    ...
    t.drive("in_payload_word", 5, at=0)
    t.drive("in_ctrl_valid", 1, at=0)
    t.expect("out_ctrl_valid", 0, at=0)
    t.finish(at=int(p["finish"]))


if __name__ == "__main__":
    print(compile(build, name="tb_pipeline_builder_top", **DEFAULT_PARAMS).emit_mlir())
