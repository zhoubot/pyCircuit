...
def Cache(
    ...
    *,
    ...
    return m.bundle_connector(
        resp_valid=m.as_connector(resp_valid, name="resp_valid"),
        resp_ready=m.as_connector(resp_ready, name="resp_ready"),
        resp_hit=m.as_connector(resp_hit, name="resp_hit"),
        resp_data=m.as_connector(resp_data, name="resp_data"),
        miss=m.as_connector(miss, name="miss"),
    )
